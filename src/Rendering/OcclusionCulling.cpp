...
// 2026-08-09：CPU 遮挡剔除（IsModelOccluded/IsPointOccluded/四叉树 QueryOverlaps）已清理——精度不保守（采样射线可能误剔可见物），
...
// 2026-08-09：subMesh 级 TLAS 视锥遍历（用户建议：BVH 层级剪枝替代线性遍历——节点 AABB 不在视锥则整棵子树跳过）
                                                               ...
                                                               ECS::Entity currentEntity)
{
    ...
    // 2026-08-09：视锥剔除改用 subMesh 级 BVH（TLAS 树遍历剪枝，替代线性遍历；BVH 不可用时回退线性）
