...
function Get-HostEvidence {
    ...
    foreach ($relative in @("out\build\x64-Release\MikanEngine.exe", "out\build\x64-Release\MikanTestRunner.exe", "out\build\x64-Release\Game.dll", "out\build\x64-Release\Gamecesiumwalk.dll")) {
