...
#
# 用法：
#   powershell -NoProfile -ExecutionPolicy Bypass -File tools\scene_command.ps1 -ScenePath assets\contact2d.json -CommandsPath tools\scene_command.example.json -TestLayer gameplay -SkipTestBuild
#
